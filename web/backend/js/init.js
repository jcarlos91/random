...
function addFlashError( message ){
    console.log( 'Flash Error' );
    $( '.content' ).prepend( '<div class="alert alert-danger alert-dismissible"><button class="close" aria-label="close" data-dismiss="alert" type="button" ><span aria-hidden="true">×</span></button>' + message + '</div>' );
    console.log( 'Flash Error' );
}
